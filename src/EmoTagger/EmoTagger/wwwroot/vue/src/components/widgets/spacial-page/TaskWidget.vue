    ...
    <div class="d-flex justify-content-between align-items-center mt-4">
      <div class="iq-media-group-1">
        <a href="#" class="iq-media-1">
          <img src="~/assets/images/avatars/06.png" class="img-fluid icon iq-icon-box-2 rounded" alt="001" />
        </a>
        <a href="#" class="iq-media-1">
          <img src="~/assets/images/avatars/07.png" class="img-fluid icon iq-icon-box-2 rounded" alt="001" />
        </a>
        <a href="#" class="iq-media-1">
          <img src="~/assets/images/avatars/02.png" class="img-fluid icon iq-icon-box-2 rounded" alt="001" />
        </a>
      </div>
