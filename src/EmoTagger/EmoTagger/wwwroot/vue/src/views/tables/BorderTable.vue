      ...
      <b-card>
        ...
        <b-card-body>
          <div class="custom-table-effect table-responsive border rounded">
            <table id="datatable" class="table mb-0" data-toggle="data-table">
              <thead>
                <tr class="bg-white">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/03.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/04.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/05.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/06.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/07.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/02.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/09.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                          <h5 class="iq-sub-label">Anne Teak</h5>
                          <p class="mb-0">@musk</p>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/10.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <div class="media-support-info">
                          <h5 class="iq-sub-label">Anne Teak</h5>
                          <p class="mb-0">@musk</p>
