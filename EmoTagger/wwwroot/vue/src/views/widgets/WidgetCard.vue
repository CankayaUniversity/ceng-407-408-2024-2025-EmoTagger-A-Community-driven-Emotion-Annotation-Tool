        ...
        <div class="comment-area mt-3">
          ...
          <form class="form" action="#">
            <div class="input-group mb-3">
              ...
              <b-button id="basic-addon2" tag="button" vaiant="primary">
        ...
        <b-card-body>
          <div class="d-grid gap-card grid-cols-3">
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/38.png">
              <img src="~/assets/images/dashboard/38.png" class="img-fluid bg-soft-info rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/42.png">
              <img src="~/assets/images/dashboard/42.png" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/40.png">
              <img src="~/assets/images/dashboard/40.png" class="img-fluid bg-soft-info rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="assets/images/dashboard/41.png">
              <img src="~/assets/images/dashboard/41.png" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/42.png">
              <img src="~/assets/images/dashboard/42.png" class="img-fluid bg-soft-warning rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/43.png">
              <img src="~/assets/images/dashboard/43.png" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/44.png">
              <img src="~/assets/images/dashboard/44.png" class="img-fluid bg-soft-danger rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/41.png">
              <img src="~/assets/images/dashboard/41.png" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy" />
            </a>
            <a data-fslightbox="gallery" href="~/assets/images/dashboard/38.png">
              <img src="~/assets/images/dashboard/38.png" class="img-fluid bg-soft-success rounded" alt="profile-image" loading="lazy" />
            </a>
          </div>
        </b-card-body>
      </b-card>
      ...
      <b-card no-body>
        ...
        <b-card-body>
          <ul class="list-inline m-0 p-0">
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-warning rounded-pill"><img src="~/assets/images/dashboard/44.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
            ...
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-danger rounded-pill"><img src="~/assets/images/dashboard/40.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Robert Fox</h6>
                <p class="mb-0">4 mutual friends</p>
              </div>
            ...
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-dark rounded-pill"><img src="~/assets/images/dashboard/43.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Jenny Wilson</h6>
            ...
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-primary rounded-pill"><img src="~/assets/images/dashboard/44.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Cody Fisher</h6>
            ...
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-info rounded-pill"><img src="~/assets/images/dashboard/38.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Bessie Cooper</h6>
            ...
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-warning rounded-pill"><img src="~/assets/images/dashboard/42.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Wade Warren</h6>
            ...
            <li class="d-flex mb-4 align-items-center">
              <div class="img-fluid bg-soft-success rounded-pill"><img src="~/assets/images/dashboard/38.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Guy Hawkins</h6>
            ...
            <li class="d-flex align-items-center">
              <div class="img-fluid bg-soft-info rounded-pill"><img src="~/assets/images/dashboard/40.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
              <div class="ms-3 flex-grow-1">
                <h6>Floyd Miles</h6>
