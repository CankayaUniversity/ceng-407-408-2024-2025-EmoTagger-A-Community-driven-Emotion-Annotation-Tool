            ...
            <table class="table table-striped mb-0">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/11.png" alt="" loading="lazy" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/12.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/13.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/14.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/15.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/16.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/17.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/18.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <h5 class="iq-sub-label">Anne Teak</h5>
                        <p class="mb-0">@musk</p>
                      </div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="~/assets/images/avatars/19.png" alt="" loading="lazy" />
                      <div class="media-support-info">
                        <h5 class="iq-sub-label">Anne Teak</h5>
                        <p class="mb-0">@musk</p>
                      </div>
