<template>
  <b-card>
    <b-card-header class="d-flex align-items-center justify-content-between pb-4">
      ...
      <div class="dropdown">
        <span id="dropdownMenuButton7" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" role="button"> 29 mins </span>
    ...
    <b-card-body class="p-0">
      ...
      <div class="comment-area p-3">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center me-3">
              <icon-component type="outlined" icon-name="heart" :size="20" />
        ...
        <ul class="list-inline p-0 m-0">
          ...
          <li>
            <div class="d-flex">
              <img src="~/assets/images/avatars/04.png" alt="userimg" class="avatar-50 p-1 pt-2 bg-soft-primary rounded-pill img-fluid" loading="lazy" />
              <div class="ms-3">
  ...
  <b-card>
    <b-card-header class="d-flex align-items-center justify-content-between pb-4">
      ...
      <div class="dropdown">
        <span id="dropdownMenuButton07" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" role="button"> 1 Hr </span>
