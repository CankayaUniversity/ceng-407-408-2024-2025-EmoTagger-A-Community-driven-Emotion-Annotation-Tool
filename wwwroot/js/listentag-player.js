...
const minimumPlayTime = 3; // Kaydetmek için minimum dinleme süresi (saniye)
let isGlobalLogging = false; // Global loglama durumu (çift kayıtları önlemek için)
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    audioPlayer.addEventListener('timeupdate', function () {
        if (isGlobalLogging) return; // Eğer zaten bir loglama işlemi devam ediyorsa çık
