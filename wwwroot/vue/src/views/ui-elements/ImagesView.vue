    ...
    <b-col sm="12" lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <img src="~/assets/images/page-img/07.jpg" class="img-fluid" alt="Responsive image" />
        </b-card-body>
      </b-card>
    ...
    <b-col sm="12" lg="6">
      ...
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <img src="~/assets/images/page-img/26.jpg" class="mt-2 img-fluid rounded float-right" alt="Responsive image" />
        </b-card-body>
      </b-card>
      <b-card no-body>
        <b-card-header class="d-flex justify-content-between">
