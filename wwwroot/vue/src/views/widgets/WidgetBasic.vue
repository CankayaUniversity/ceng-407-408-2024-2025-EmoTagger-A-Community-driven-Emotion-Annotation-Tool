  ...
  <b-row>
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        ...
        <div class="d-flex align-items-center justify-content-between mt-3">
          <div>
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="2648" /></h2>
            26.84%
          </div>
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        ...
        <div class="mt-4">
          <b-progress :max="0" class="bg-soft-info shadow-none w-100 mb-3" height="8px">
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        ...
        <div class="mt-4">
          <b-progress :max="0" class="bg-soft-success shadow-none w-100 mb-3" height="8px">
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        ...
        <div class="mt-4">
          <b-progress :max="0" class="bg-soft-primary shadow-none w-100 mb-3" height="8px">
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card class="bg-soft-info">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="5600" /></h2>
            Doctors
          </div>
        </div>
      </b-card>
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card class="card bg-soft-danger">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="3500" /></h2>
            Patients
          </div>
        </div>
      </b-card>
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card class="bg-soft-primary">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="4500" /></h2>
            Pharmacists
          </div>
        </div>
      </b-card>
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            Customers
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="75" /></h2>
          </div>
        </div>
      </b-card>
    </b-col>
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            Products
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="60" /></h2>
          </div>
        </div>
      </b-card>
    </b-col>
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            User
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="80" /></h2>
          </div>
        </div>
      </b-card>
    </b-col>
    <b-col class="col-lg-3 col-md-6">
      <b-card>
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            Category
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="45" /></h2>
          </div>
        </div>
      </b-card>
    </b-col>
    ...
    <b-col class="col-lg-3 col-md-6">
      <b-card class="border-bottom border-4 border-0 border-danger">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <span><Vue3autocounter ref="counter" :start-amount="0" :end-amount="1200" /></span>
          </div>
        </div>
      </b-card>
    </b-col>
    <b-col class="col-lg-3 col-md-6">
      <b-card class="border-bottom border-4 border-0 border-warning">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <span>$<Vue3autocounter ref="counter" :start-amount="0" :end-amount="54000" /></span>
          </div>
        </div>
      </b-card>
    </b-col>
    ...
    <b-col class="col-xl-4 col-lg-6">
      <b-card>
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div>
            <h1><Vue3autocounter ref="counter" :start-amount="0" :end-amount="250" />M</h1>
    ...
    <b-col lg="4">
      <b-card>
        <h2>$<Vue3autocounter ref="counter" :start-amount="0" :end-amount="3450" /></h2>
        ...
        <div class="mt-3">
          <div class="pb-3">
            ...
            <b-progress :max="0" class="bg-soft-info shadow-none w-100" height="10px">
          ...
          <div class="pb-3">
            ...
            <b-progress :max="0" class="bg-soft-success shadow-none w-100" height="10px">
          ...
          <div class="pb-3">
            ...
            <b-progress :max="0" class="bg-soft-primary shadow-none w-100" height="10px">
          ...
          <b-card>
            <div class="d-flex flex-column align-items-between">
              ...
              <div class="mt-3">
                <span>CUSTOMER</span>
                <div>
                  <h3><Vue3autocounter ref="counter" :start-amount="0" :end-amount="60586" /></h3>
                </div>
              </div>
              <div class="mt-3">
                <div class="badge bg-primary">
          ...
          <b-card>
            <div class="d-flex flex-column align-items-between">
              ...
              <div class="mt-3">
                <span>SALES</span>
                <div>
                  <h3><Vue3autocounter ref="counter" :start-amount="0" :end-amount="80586" /></h3>
                </div>
              </div>
              <div class="mt-3">
    ...
    <b-col lg="4">
      <b-card no-body class="p-3">
        ...
        <div class="text-center">
          <h1>-<Vue3autocounter ref="counter" :start-amount="0" :end-amount="1056" />K</h1>
      ...
      <b-card no-body class="p-3">
        <h5>Liabilities</h5>
        <div class="text-center">
          <h1>-<Vue3autocounter ref="counter" :start-amount="0" :end-amount="4252" />K</h1>
          <p class="mb-0">Lorem ipsum dolor sit amet</p>
        </div>
      </b-card>
      <b-card no-body class="p-3">
        ...
        <div class="text-center">
          <h1>-<Vue3autocounter ref="counter" :start-amount="0" :end-amount="3804" />K</h1>
          <p class="mb-0">Lorem ipsum dolor sit amet</p>
        </div>
      </b-card>
    </b-col>
          ...
          <b-card>
            <div class="d-flex justify-content-between">
              <div>
                ...
                <div class="mt-2">
                  <h2>$<Vue3autocounter ref="counter" :start-amount="0" :end-amount="35000" /></h2>
                </div>
              </div>
              <div>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <div class="mt-2">
                    <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="2500" /></h2>
                  </div>
                </div>
                <div>
