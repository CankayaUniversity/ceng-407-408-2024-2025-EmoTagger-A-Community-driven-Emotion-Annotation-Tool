      ...
      <b-card class="mb-4">
        <template #header>
          <div class="d-flex align-items-center justify-content-center">
            <h4 class="card-title mb-0 flex-grow-1">Solid {{ ArrIcons.length }}</h4>
            <div>
              <input v-model="search" class="form-control" name="search" placeholder="Search Icon" @keyup="onSearchUpdate" />
            </div>
          </div>
        </template>
        <div class="icon-grid">
